...
name: 'HydroGlobe-2: A Global Reanalysis for Water, Energy, and Carbon Cycle Variables'
...
layers:
  - id: lis-global-da-evap-5
    ...
    info:
      ...
      unit: kg m-2 s-1
  - id: lis-global-da-gpp-5
    stacCol: lis-global-da-gpp-5
  ...
  - id: lis-global-da-swe-5
    stacCol: lis-global-da-swe-5
  ...
  - id: lis-global-da-streamflow-5
    stacCol: lis-global-da-streamflow-5
    name: 'Streamflow'
    type: raster
    ...
    compare:
      datasetId: global-reanalysis-da-5
      layerId: lis-global-da-streamflow-5
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          return `${dateFns.format(datetime, 'LLL dd yyyy')} VS ${dateFns.format(compareDatetime, 'LLL dd yyyy')}`;
        }
  ...
  - id: lis-global-da-qs-5
    stacCol: lis-global-da-qs-5
    name: 'Surface runoff'
    type: raster
  ...
  - id: lis-global-da-qsb-5
    stacCol: lis-global-da-qsb-5
  ...
  - id: lis-global-da-tws-5
    stacCol: lis-global-da-tws-5
  ...
  - id: lis-global-da-totalprecip-5
    stacCol: lis-global-da-totalprecip-5
    ...
    compare:
      datasetId: global-reanalysis-da-5
      layerId: lis-global-da-totalprecip-5
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          return `${dateFns.format(datetime, 'LLL dd yyyy')} VS ${dateFns.format(compareDatetime, 'LLL dd yyyy')}`;
        }
...
This dataset is a new global reanalysis that includes variables – such as terrestrial water storage, snow water equivalent, and gross primary productivity – to help quantify the water and energy budget. At the present time, the model reanalysis output is available at 5 km spatial resolution and a daily temporal resolution from January 1, 2003 through December 31, 2024. Details on the model setup are provided below, as well as links to how the reanalysis output can be used to address key science questions.
