...
<Block>
  ...
  **Authors**: NLDAS-3 developers and science teams at the NASA Goddard Hydrological Sciences Laboratory and Marshall Space Flight Center's Earth Science Branch (including David Mocko, Fadji Maina, Kim Locke, Sujay Kumar, Kristen Whitney, Rishi Anand, Siddharth Chaudhary, Chris Hain, Shahryar Ahmad, Rajat Bindlish, Nishan Biswas, Jim Geiger, Augusto Getirana, Thomas Holmes, Timothy Lahmers, Pang-Wei Liu, Wanshu Nie, Melissa Wrzesien, John Bolten, Andrew White, Vikalp Mishra, Robert Junod, Ryan Wade, Mitchell Dodson, Jonathan Case, Justin Pflug, Olya Skulovich, Mahya Hashemi, Trent Cowan, Tricia Parker, and Steve Stolze)
  ...
  <Figure>
      <Image
      src={'./images/story/nldas-fig1.png'}
    />
...
<Block>
  ...
  <Figure>
      <Image
      src={'./images/story/nldas3-fig1b.png'}
    />
...
<Block>
  ...
  - [NLDAS-2](https://www.earthdata.nasa.gov/dashboard/data-catalog/nldas2)
  - [NLDAS-3](https://www.earthdata.nasa.gov/dashboard/data-catalog/nldas3)
  </Prose>
</Block>
...
<Block>
  ...
  NLDAS-3 will employ the Noah-MP land surface model shown below (He et al., 2023) and implemented within LIS. 
    <Figure>
      <Image
      src={'./images/story/nldas-fig7.png'}
    />
...
<Block>
  ...
  - [SPoRT Land Information System](https://www.earthdata.nasa.gov/dashboard/data-catalog/soil-moisture)
  - [FLDAS Surface Soil Moisture Anomalies](https://www.earthdata.nasa.gov/dashboard/data-catalog/fldas-soil-moisture-anomalies)
  - [A Global Reanalysis for Water, Energy, and Carbon Cycle Variables](https://www.earthdata.nasa.gov/dashboard/data-catalog/global-reanalysis-da)
  </Prose>
</Block>
