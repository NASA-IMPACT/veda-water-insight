...
<Block>
    <Figure>
    <Chart
      dataPath={new URL('/charts/story/SouthAsia_TWS_annual_data.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='Data Type'
      xKey='Year'
    ...
    />
     ...
     <Chart
       dataPath={new URL('/charts/story/SouthAsia_GPP_annual_data.csv', import.meta.url).href}
       dateFormat="%Y"
       idKey='Data Type'
       xKey='Year'
       yKey='GPP'
    ...
    <Chart
      dataPath={new URL('/charts/story/SouthAsia_ET_annual_data.csv', import.meta.url).href}
      dateFormat="%Y"
      idKey='Data Type'
      xKey='Year'
      yKey='Water Components'
