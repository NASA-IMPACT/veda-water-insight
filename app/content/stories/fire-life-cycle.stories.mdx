...
media:
  src: /images/story/fire-cover.png
...
<Block>
  <Figure>
    <Image
      src={"/images/story/dixie_burn_2.png"}
...
<Block type="wide">
  <Figure>
    <Chart
      dataPath={/images/story/Burnarea_timeseries_WUS.csv'}
      dateFormat="%Y"
      idKey='source'
      xKey='year'
...
<Block>
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={'/images/story/fire_hyro_VIZ01_final_HD_1080p59.94.mp4'}
      />
...
<Block>
  ...
  <Figure>
    <Image
      src={"/images/story/cv_irrig.jpeg"}
...
<ScrollytellingBlock>
  ...
  >
    ...
    <Chart
      dataPath={'images/story/ET_timeseries_PreacherNV.csv'}
      dateFormat="%m/%d/%y"
      idKey='source'
      xKey='Date'
      yKey='ET (mm)'
  ...
  >
    ...
    <Chart
      dataPath={'/images/story/ET_timeseries_NatchezCA.csv'}
      dateFormat="%m/%d/%y"
      idKey='source'
      xKey='Date'
      yKey='ET (mm)'
  ...
  >
    ...
    <Chart
      dataPath={'/images/story/ET_timeseries_ThomasCA.csv'}
      dateFormat="%m/%d/%y"
      idKey='source'
      xKey='Date'
      yKey='ET (mm)'
...
<Block>
  ...
  <Figure>
    <Image
      src={"/images/story/frp_barc_plot.png"}
