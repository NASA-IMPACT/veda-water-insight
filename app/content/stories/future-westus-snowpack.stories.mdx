...
media:
  src: /images/story/future-westus-snowpack/snow-projections-median.358ebb24.jpg
...
<Block type='wide'>
  <Figure>
    <Image
       src={new URL("/images/story/future-westus-snowpack/aggregated_climateDeltas.jpg", import.meta.url).href}
...
<Block>
   <Figure>
     <Image 
       src={new URL("/images/story/future-westus-snowpack/habitat_spaghettiPlots.jpg", import.meta.url).href}
       alt="changes to thresholded habitat across elevation bands" 
      />
   </Figure>
   <Prose>
