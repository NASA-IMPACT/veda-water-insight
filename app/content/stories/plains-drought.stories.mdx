...
<Block>
    ...
    <Figure>
        <Image
            src={'/images/story/plains-drought/tmp_modis_slider.png'}
            alt='MODIS Terra Corrected Reflectance Bands 7-2-1; Left: Pre-fire July 13, Right: Active fire July 23.'
            align='left'
        />
        <Caption>
          MODIS Terra Corrected Reflectance Bands 7-2-1; Left: Pre-fire July 13, Right: Active fire July 23. The MODIS fire product MCD64A1 also captures the extent of the wildfire        
        </Caption>
    </Figure>
</Block>
...
<Block>
    <Figure>
        <Image
            src={'/images/story/plains-drought/tmp_arcgis_filler.png'}
            alt='MODIS Terra Corrected Reflectance Bands 7-2-1; Left: Pre-fire July 13, Right: Active fire July 23.'
            align='left'
        />
        <Caption>
...
<Block>
  <Prose>
    #### Authorship
    Authors: NASA EIS Freshwater<sup>1</sup>

    Developers: NASA IMPACT<sup>2</sup>

    <sup>1</sup> National Aeronautics and Space Administration Earth Information System

    <sup>2</sup> NASA Interagency Implementation of Advanced Concepts Team
  </Prose>
</Block>