...
<Block>
  ...
  <Figure>
    <Image
      src={"/images/story/AlgalBlooms_LakeErie.jpg"}
...
<Block>
  <Figure>
    <Image
      src={"/images/story/Hypoxic_Mississippi.jpg"}
      alt="Image of hypoxic zone at the mouth of Mississippi river in Gulf of Mexico."
    />
    <Caption
      attrAuthor='NOAA'
...
<Block>
  ...
  <Figure>
    <Image
      src={"/images/story/dead_chum_salmon.jpeg"}
...
<Block type='wide'>
  <Figure>
    <Image
      src={"/images/story/USGS_WQSites.png"}
...
<Block type='wide'>
  <Figure>
     <video style={{ width: '100%', aspectRatio: "16/9" }} controls>
      <source
        src={'/images/story/animated-no3-2018.mp4'}
      />
...
<Block type='wide'>
  <Figure>
    <CompareImage
      leftImageSrc={"/images/story/pre_flood.png"}
      leftImageAlt="Changes in nitrate loads before flooding in 2016"
      rightImageSrc={"/images/story/post_flood.png"}
...
<Block>
  ...
  <Figure>
    <Image
      src={"/images/story/StreamTemp_WesternUS.png"}
